...
from lol_cam_switcher.buffer.recorder import ReplayRecorder
from lol_cam_switcher.common.event_source import EventSource
...
from lol_cam_switcher.obs.controller import OBSController
from lol_cam_switcher.session_log.game_logger import GameSessionLogger, default_logs_dir
...
class DirectorEngine:
    ...
    def start(self) -> None:
        ...
        self.game_log.log_info("LolCamSwitcher engine started")
